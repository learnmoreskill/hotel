            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Add room information</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form class="form-material" action="{{route('room.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                                      @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group form-default">
                                                ...
                                                <span class="form-bar"></span>
                                                <label class="float-label">Price (include Per Night/Day/Month)</label>
                                            </div>
