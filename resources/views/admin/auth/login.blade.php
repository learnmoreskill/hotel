...
<head>
    <title>Login - {{$site_setting->name}}</title>
  ...
  <body style="background-image: url({{asset('frontend/images/hero_1.jpg ')}});" data-aos="fade" data-stellar-background-ratio="0.5">
  <!-- Pre-loader start -->
                ...
                <div class="col-sm-12">
                    ...
                    @csrf
                            <div class="text-center">
                                <img src="{{asset($site_setting->logo2)}}" alt="logo.png">
                            </div>
